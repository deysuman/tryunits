...
exports.createTransaction = function (params) {
    ...
    if (params.feeSingleKeyWIF) {
        var feeSingleKey = bitcoin.ECPair.fromWIF(params.feeSingleKeyWIF, bitcoin.getNetwork());
...
exports.signTransaction = function (params) {
    ...
    for (var index = 0; index < txb.tx.ins.length; ++index) {
        ...
        if (hdPath) {
            ...
            var path_1 = keychain.path + subPath + chainPath;
            privKey = hdPath.deriveKey(path_1);
        }
