...
var Btg = /** @class */ (function (_super) {
    ...
    function Btg(network) {
        return _super.call(this, network || bitcoin.networks.bitcoingold) || this;
    }
    ...
    Btg.prototype.recoveryBlockchainExplorerUrl = function (url) {
        var baseUrl = common.Environments[this.bitgo.env].btgExplorerBaseUrl;
        if (!baseUrl) {
